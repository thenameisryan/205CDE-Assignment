...
$qry_prod = "SELECT * FROM product 
                WHERE product_id = '".$_GET['deleteprod']."'";  
...
<body>
	...
	<section class="page-top-section set-bg" data-setbg="img/page-top-bg/4.jpg">
		<div class="page-info">
			<h2>Delete <?php echo $prod['product_name'];?></h2>
			<div class="site-breadcrumb">
				<a href="javascript:history.back()">Back</a>  /
				<span>Delete <?php echo $prod['product_name'];?></span>
			</div>
		</div>
	</section>
	<!-- Page top end-->
			...
			<div class="row">
				<div class="col-lg-10 order-1 order-lg-2 contact-text text-white">
					<form class="contact-form" method="post" action="" autocomplete="off">
						<h3>Confirm delete product <font color="#b01ba5"><b><?php echo $prod['product_name'];?></b></font>?</h3><br><br><br>
						<input type="hidden" name="edit_prod_id" value="<?php echo $prod['product_id'];?>">
						<a href="product_list.php?cat=all" class="site-btn"><font color="black">No</font><img src="img/icons/double-arrow.png" alt="#"/></a>
						<button class="site-btn" type="submit" name="delete_prod">Confirm<img src="img/icons/double-arrow.png" alt="#"/></button>
					</form>
				</div>
			</div>
		</div>
